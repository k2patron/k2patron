...
jQuery(document).ready(function ($) {
	...
	var uploader = new qq.FileUploader({
		...
		onSubmit: function(id, fileName) {
					...
					$('<div id="uploadfile-'+id+'" class="file-box"><span class="qq-upload-file-status">{$lang['media_upload_st6']}</span><span class="qq-upload-file">&nbsp;'+fileName+'</span><span class="qq-status"><span class="qq-upload-spinner"></span><span class="qq-upload-size"></span></span><div class="progressbar"><span class="progressbarspan" style="width:0%;">0%</span></div></div>').appendTo('#file-uploader');
		...
		onProgress: function(id, fileName, loaded, total){
					...
					$('#uploadfile-'+id+' .progressbarspan').width( proc + '%');
