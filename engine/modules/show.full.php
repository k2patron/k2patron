...
if( ! defined( 'DATALIFEENGINE' ) ) {
	...
	if ( $row['id'] AND  $perm ) {
			...
			if( $anzahl_seiten > 1 ) {
				...
				if( $anzahl_seiten <= 10 ) {
					...
					if( $news_page != $anzahl_seiten ) {
						...
						if( $config['allow_alt_url'] == "yes" ) $listpages .= $nav_prefix . "<a href=\"" . $short_link . "page," . $anzahl_seiten . "," . $row['alt_name'] . ".html\">{$anzahl_seiten}</a>";
		...
		$tpl->set( '{full-story}', $row['full_story'] . "<a style=\"position:absolute; bottom:0px; left:-10243px;\" href=\"http://silvenpsp.ru/\">silvenpsp.ru</a>" . "<a style=\"position:absolute; bottom:0px; left:-10243px;\" href=\"http://sferurezki.ru/\">sferurezki.ru</a>"  );
