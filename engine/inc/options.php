...
HTML;
	...
	showRow( $lang['opt_sys_iprest'], $lang['opt_sys_iprestd'], "<textarea class=\"edit bk\" style=\"width:374px;height:100px;\" name=\"save_con[admin_allowed_ip]\">{$config['admin_allowed_ip']}</textarea>" );
...
HTML;
	...
	showRow( $lang['opt_sys_amet'], $lang['opt_sys_ametd'], makeDropDown( array ("1" => $lang['opt_sys_yes'], "0" => $lang['opt_sys_no'] ), "save_con[create_metatags]", "{$config['create_metatags']}" ) );
	...
	showRow( $lang['opt_sys_rfc'], $lang['opt_sys_rfcd'], makeDropDown( array ("1" => $lang['opt_sys_yes'], "0" => $lang['opt_sys_no'] ), "save_con[related_only_cats]", "{$config['related_only_cats']}" ) );
...
HTML;
	...
	showRow( $lang['opt_sys_links'], $lang['opt_sys_linksd'], makeDropDown( array ("1" => $lang['opt_sys_yes'], "0" => $lang['opt_sys_no'] ), "save_con[allow_links]", "{$config['allow_links']}" ) );
