...
if( $action == "del" ) {
	...
	if( $action == "add" ) {
		...
		$spamfilter_sel[2] = 'selected="selected"';
		...
		$files_type_value = $user_group[4]['files_type'];
		$max_file_size_value = $user_group[4]['max_file_size'];
		$files_max_speed_value = $user_group[4]['files_max_speed'];
		...
		if( $user_group[$id]['pm_question'] ) $pm_question_yes = "checked"; else $pm_question_no = "checked";
		if( $user_group[$id]['captcha_feedback'] ) $captcha_feedback_yes = "checked"; else $captcha_feedback_no = "checked";
		if( $user_group[$id]['feedback_question'] ) $feedback_question_yes = "checked"; else $feedback_question_no = "checked";
		if( $user_group[$id]['allow_lostpassword'] ) $allow_lostpassword_yes = "checked"; else $allow_lostpassword_no = "checked";
...
<div id="dle_tabView1">
		<div class="tabset" id="tabset">
			<a id="a" class="tab  {content:'cont_1'}">{$lang['tabs_gr_all']}</a><a id="b" class="tab  {content:'cont_2'}">{$lang['tabs_gr_news']}</a><a id="c" class="tab  {content:'cont_3'}" >{$lang['tabs_gr_comments']}</a><a id="d" class="tab  {content:'cont_4'}" >{$lang['tabs_gr_cap']}</a><a id="e" class="tab  {content:'cont_5'}" >{$lang['tabs_gr_admin']}</a>
		</div>
...
<table width="100%">
    <tr>
        ...
        <td width="480" style="padding-top:2px;padding-bottom:2px;"><input class="edit bk" type="text" style="width:368px;" name="group_name" value="{$group_name_value}"></td>
    </tr>
    ...
    <tr>
        ...
        <td style="padding-top:2px;padding-bottom:2px;"><input class="edit bk" type="text" style="width:368px;" name="group_icon" value="{$group_icon_value}"></td>
    </tr>
	<tr><td background="engine/skins/images/mline.gif" height=1 colspan=2></td></tr>
    <tr>
        <td style="padding:4px;" class="option"><b>{$lang['group_pref']}</b><br /><span class="small">{$lang['hint_gpref']}</span></td>
        <td style="padding-top:2px;padding-bottom:2px;"><input class="edit bk" type="text" style="width:368px;" name="group_prefix" value="{$group_prefix_value}"></td>
    </tr>
	<tr><td background="engine/skins/images/mline.gif" height=1 colspan=2></td></tr>
    <tr>
        <td style="padding:4px;" class="option"><b>{$lang['group_suf']}</b><br /><span class="small">{$lang['hint_gsuf']}</span></td>
        <td style="padding-top:2px;padding-bottom:2px;"><input class="edit bk" type="text" style="width:368px;" name="group_suffix" value="{$group_suffix_value}"></td>
    </tr>
	<tr><td background="engine/skins/images/mline.gif" height=1 colspan=2></td></tr>

    <tr>
        <td style="padding:4px;" class="option"><b>{$lang['group_lostpass']}</b><br /><span class="small">{$lang['hint_glostpass']}</span></td>
        <td style="padding-top:2px;padding-bottom:2px;"><input type="radio" name="allow_lostpassword" {$allow_lostpassword_yes} value="1" > {$lang['opt_sys_yes']} <input type="radio" name="allow_lostpassword" {$allow_lostpassword_no} value="0" > {$lang['opt_sys_no']}</td>
    </tr>
	<tr><td background="engine/skins/images/mline.gif" height=1 colspan=2></td></tr>
...
<table width="100%">
	...
	<tr><td background="engine/skins/images/mline.gif" height=1 colspan=2></td></tr>
    <tr>
        <td style="padding:4px;" class="option"><b>{$lang['group_fspam']}</b><br /><span class="small">{$lang['hint_fspam']}</span></td>
        <td style="padding-top:2px;padding-bottom:2px;"><select name="spamfilter">
