...
HTML;
	...
	if ($row['autor'] != $member_id['name'] AND $user_group[$member_id['user_group']]['allow_all_edit'] AND !$row['approve']) $spam_btn = "<input onclick=\"MarkSpam('{$id}', '{$dle_login_hash}'); return false;\" type=\"button\" class=\"btn btn-danger\" value=\"{$lang['btn_spam']}\" style=\"width:100px;\">&nbsp;"; else $spam_btn = "";
...
<div style="padding-left:150px;padding-top:5px;padding-bottom:5px;">
	<input type="submit" class="btn btn-success" value="{$lang['news_save']}" style="width:100px;">&nbsp;
