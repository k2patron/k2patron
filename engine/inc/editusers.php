...
<script type="text/javascript">
    ...
    <tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td style="padding:5px;">{$lang['edit_upp']}</td>
		<td>&nbsp;</td>
        <td colspan="3"><input class="edit bk" style="text-align:center;" type="text" name="news_per_page" id="news_per_page" size="8" maxlength="7" value="{$news_per_page}"></td>
    </tr>
    <tr>
