        ...
        if (count($xfields) == 0) {
          echo "<tr><td colspan=\"2\" align=\"center\"><br /><br />$lang[xfield_xnof]</td></tr>";
			...
			foreach ($xfields as $name => $value) {
				...
				$x_list .= "<li id=\"list_{$name}\"><div><b id=\"x_uname\" class=\"s-el\">{$value[0]}</b><b id=\"x_cats\" class=\"s-el\">{$lang['xp_descr']}: {$value[1]}</b><b id=\"x_utype\" class=\"s-el\">{$lang['xfield_xtype']}: {$type}</b><b id=\"x_par\" class=\"s-el\">{$lang['xp_regh']}: {$p1}</b><b id=\"x_par\" class=\"s-el\">{$lang['xp_edith']}: {$p2}</b><b id=\"x_l\" class=\"s-el\">{$lang['xp_privath']}: {$p3}</b><span><a href=\"?mod=userfields&xfieldsaction=configure&xfieldssubaction=edit&xfieldsindex={$name}&user_hash={$dle_login_hash}\"><img style=\"vertical-align: middle;border:none;\" title=\"{$lang['cat_ed']}\" alt=\"{$lang['cat_ed']}\" src=\"engine/skins/images/notepad.png\" /></a>&nbsp;&nbsp;<a class=\"maintitle\" href=\"?mod=userfields&xfieldsaction=configure&xfieldssubaction=delete&xfieldsindex={$name}&user_hash={$dle_login_hash}\"><img style=\"vertical-align: middle;border:none;\" alt=\"{$lang['cat_del']}\" title=\"{$lang['cat_del']}\" src=\"engine/skins/images/delete.png\" /></a></span></div>";		
...
<script>
	$(document).ready(function(){
		...
		$('#xfsort').click(function(){
			...
			var url = "action=userxfsort&user_hash=<?php echo $dle_login_hash; ?>&"+xfsort;
