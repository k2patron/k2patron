...
HTML;
	...
	showRow( $lang['vconf_awidht'], $lang['vconf_awidhtd'], "<input class=\"edit bk\" type=text style=\"text-align: center;\" name=\"save_con[audio_width]\" value=\"{$video_config['audio_width']}\" size=10>" );
	...
	showRow( $lang['opt_sys_html5'], $lang['opt_sys_html5d'], makeDropDown( array ("1" => $lang['opt_sys_yes'], "0" => $lang['opt_sys_no'] ), "save_con[use_html5]", "{$video_config['use_html5']}" ) );
